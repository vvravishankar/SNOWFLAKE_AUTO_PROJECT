...
-- ============================================================================
-- 18. PUBLIC ROLE — DEMO-SAFE ACCESS
-- ============================================================================
-- Grant PUBLIC the same read access as other AutoPulse roles so that
-- Workspace Streamlit apps (which run as PUBLIC) work out of the box.
-- Also sets FUTURE GRANTS so new objects are automatically accessible.

USE ROLE ACCOUNTADMIN;

-- Database + warehouse
GRANT USAGE ON DATABASE AUTOPULSE_AI TO ROLE PUBLIC;
GRANT USAGE ON WAREHOUSE AUTOPULSE_WH TO ROLE PUBLIC;

-- All schemas (current + future)
GRANT USAGE ON ALL SCHEMAS IN DATABASE AUTOPULSE_AI TO ROLE PUBLIC;
GRANT USAGE ON FUTURE SCHEMAS IN DATABASE AUTOPULSE_AI TO ROLE PUBLIC;

-- SELECT on all tables in every schema (current + future)
GRANT SELECT ON ALL TABLES IN SCHEMA AUTOPULSE_AI.RAW TO ROLE PUBLIC;
GRANT SELECT ON ALL TABLES IN SCHEMA AUTOPULSE_AI.CLEAN TO ROLE PUBLIC;
GRANT SELECT ON ALL TABLES IN SCHEMA AUTOPULSE_AI.DQ TO ROLE PUBLIC;
GRANT SELECT ON ALL TABLES IN SCHEMA AUTOPULSE_AI.OPS TO ROLE PUBLIC;
GRANT SELECT ON ALL TABLES IN SCHEMA AUTOPULSE_AI.CURATED TO ROLE PUBLIC;
GRANT SELECT ON FUTURE TABLES IN SCHEMA AUTOPULSE_AI.RAW TO ROLE PUBLIC;
GRANT SELECT ON FUTURE TABLES IN SCHEMA AUTOPULSE_AI.CLEAN TO ROLE PUBLIC;
GRANT SELECT ON FUTURE TABLES IN SCHEMA AUTOPULSE_AI.DQ TO ROLE PUBLIC;
GRANT SELECT ON FUTURE TABLES IN SCHEMA AUTOPULSE_AI.OPS TO ROLE PUBLIC;
GRANT SELECT ON FUTURE TABLES IN SCHEMA AUTOPULSE_AI.CURATED TO ROLE PUBLIC;

-- Views (current + future)
GRANT SELECT ON ALL VIEWS IN DATABASE AUTOPULSE_AI TO ROLE PUBLIC;
GRANT SELECT ON FUTURE VIEWS IN DATABASE AUTOPULSE_AI TO ROLE PUBLIC;

-- Semantic views (current + future)
GRANT SELECT ON ALL SEMANTIC VIEWS IN DATABASE AUTOPULSE_AI TO ROLE PUBLIC;
GRANT REFERENCES ON ALL SEMANTIC VIEWS IN DATABASE AUTOPULSE_AI TO ROLE PUBLIC;
GRANT SELECT ON FUTURE SEMANTIC VIEWS IN DATABASE AUTOPULSE_AI TO ROLE PUBLIC;
GRANT REFERENCES ON FUTURE SEMANTIC VIEWS IN DATABASE AUTOPULSE_AI TO ROLE PUBLIC;

-- Agents (current + future)
GRANT USAGE ON ALL AGENTS IN SCHEMA AUTOPULSE_AI.CURATED TO ROLE PUBLIC;
GRANT USAGE ON FUTURE AGENTS IN DATABASE AUTOPULSE_AI TO ROLE PUBLIC;

-- Procedures & functions (current + future)
GRANT USAGE ON ALL PROCEDURES IN DATABASE AUTOPULSE_AI TO ROLE PUBLIC;
GRANT USAGE ON ALL FUNCTIONS IN DATABASE AUTOPULSE_AI TO ROLE PUBLIC;
GRANT USAGE ON FUTURE PROCEDURES IN DATABASE AUTOPULSE_AI TO ROLE PUBLIC;
GRANT USAGE ON FUTURE FUNCTIONS IN DATABASE AUTOPULSE_AI TO ROLE PUBLIC;

-- Cortex user (needed to call agents)
GRANT DATABASE ROLE SNOWFLAKE.CORTEX_USER TO ROLE PUBLIC;

-- ACCOUNT_USAGE (needed for Ops & Cost Intelligence tab)
